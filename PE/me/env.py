...
class Environment(tk.Tk, object):
    ...
    def step(self, action):
        ...
        elif next_state in [self.coords_obstacle1, self.coords_obstacle2, self.coords_obstacle3, self.coords_obstacle4, self.coords_obstacle5,\
            self.coords_obstacle6, self.coords_obstacle7, self.coords_obstacle8, self.coords_obstacle9, self.coords_obstacle10, \
            self.coords_obstacle11, self.coords_obstacle12, self.coords_obstacle13, self.coords_obstacle14, self.coords_obstacle15, \
            self.coords_obstacle16, self.coords_obstacle17, self.coords_obstacle18, self.coords_obstacle19, self.coords_obstacle20, \
            self.coords_obstacle21, self.coords_obstacle22, self.coords_obstacle23, self.coords_obstacle24, self.coords_obstacle25, \
            self.coords_obstacle26, self.coords_obstacle27, self.coords_obstacle28, self.coords_obstacle29, self.coords_obstacle30,]:
